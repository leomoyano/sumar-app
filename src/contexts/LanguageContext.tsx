...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "login.currency": "Moneda preferida",
    "login.currency.placeholder": "Selecciona una moneda",
    ...
    "dashboard.newTable.description":
      "Ingresa un nombre para tu nueva tabla de gastos mensuales.",
    ...
    "common.error": "Error",
    "common.error.generic": "Lo siento, estamos teniendo problemas. Intenta de nuevo en un momento.",
    "common.error.authLogin": "No pudimos iniciar sesion. Revisa tus datos e intenta nuevamente.",
    "common.error.authRegister": "No pudimos crear tu cuenta. Intenta nuevamente en un momento.",
    "common.auth.verifyEmail": "Cuenta creada. Revisa tu email para confirmar el registro.",
    "common.error.invalidCredentials": "Email o contrasena incorrectos.",
    "common.error.invalidEmail": "Ese email no es valido. Proba con otro correo.",
    "common.error.emailAlreadyRegistered": "Ese email ya esta registrado.",
    "common.error.authRedirectInvalid": "La configuracion de registro no esta lista. Escribinos para activarlo.",
    "common.error.categoryCreate": "No pudimos crear la categoria. Intenta nuevamente.",
    "common.validation.requiredFields": "Completa todos los campos.",
    "common.validation.validAmount": "Ingresa un monto valido.",
    "common.validation.expenseFields": "Completa nombre y monto con un valor valido.",
    "common.category.selected": "Categoria \"{{name}}\" seleccionada",
    "common.category.created": "Categoria \"{{name}}\" creada",
    "common.save": "Guardar",
  ...
  en: {
    ...
    "login.currency": "Preferred currency",
    "login.currency.placeholder": "Select a currency",
    ...
    "dashboard.newTable.description":
      "Enter a name for your new monthly expense table.",
    ...
    "dashboard.deleteTable.description":
      "This action cannot be undone. All expenses associated with this table will be deleted.",
    "dashboard.deleteTable.cancel": "Cancel",
    "dashboard.deleteTable.confirm": "Delete",
    "dashboard.viewDetails": "View expenses",
    ...
    "expenseTable.expense.category": "Category",
    ...
    "common.error": "Error",
    "common.error.generic": "Sorry, we're having problems right now. Please try again in a moment.",
    "common.error.authLogin": "We couldn't sign you in. Check your credentials and try again.",
    "common.error.authRegister": "We couldn't create your account. Please try again in a moment.",
    "common.auth.verifyEmail": "Account created. Check your email to confirm your registration.",
    "common.error.invalidCredentials": "Incorrect email or password.",
    "common.error.invalidEmail": "That email is not valid. Please try a different one.",
    "common.error.emailAlreadyRegistered": "That email is already registered.",
    "common.error.authRedirectInvalid": "Signup configuration is not ready yet. Please contact support.",
    "common.error.categoryCreate": "We couldn't create the category. Please try again.",
    "common.validation.requiredFields": "Please fill in all fields.",
    "common.validation.validAmount": "Enter a valid amount.",
    "common.validation.expenseFields": "Please complete name and amount with a valid value.",
    "common.category.selected": "Category \"{{name}}\" selected",
    "common.category.created": "Category \"{{name}}\" created",
    "common.save": "Save",

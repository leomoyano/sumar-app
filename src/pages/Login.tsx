        ...
        <div className="max-w-md mx-auto space-y-8">
          ...
          <div className="space-y-6 pt-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-primary-foreground">{t('login.features.tracking')}</h3>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-primary-foreground">{t('login.features.conversion')}</h3>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-primary-foreground">{t('login.features.analysis')}</h3>
              </div>
            </div>
          </div>
        </div>
            ...
            <CardContent>
              <Tabs defaultValue="login" className="w-full">
                <TabsList className="grid w-full grid-cols-2">
                  ...
                  <TabsTrigger value="register">{t('login.tab.register')}</TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="login" className="space-y-4 pt-4">
                  <form onSubmit={handleLogin} className="space-y-4">
                    ...
                    <Button type="submit" className="w-full" disabled={isSubmitting}>
                      {isSubmitting ? t('login.loading') : t('login.button.login')}
                    </Button>
                  </form>
                </TabsContent>
                ...
                <TabsContent value="register" className="space-y-4 pt-4">
                  <form onSubmit={handleRegister} className="space-y-4">
                    ...
                    <Button type="submit" className="w-full" disabled={isSubmitting}>
                      {isSubmitting ? t('login.loading') : t('login.button.register')}
                    </Button>
                  </form>
                </TabsContent>
              </Tabs>
